...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/password/verify-otp', [OtpVerificationController::class, 'showOtpForm'])->name('password.otp.verify.form');
    Route::post('/password/verify-otp', [OtpVerificationController::class, 'verify'])->name('password.otp.verify');
