    ...
    <section>
        <div class="glass-card rounded-2xl p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <x-admin.primary-link href="{{ route('am.user.index') }}">{{ __('Back') }} <i data-lucide="undo-2"
        ...
        <div
            ...
            <div class="glass-card rounded-2xl p-6 md:col-span-5">
                <form action="{{ route('am.admin.update', encrypt($user->id)) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div class="space-y-2 ">
                            ...
                            <label class="input flex items-center px-2 ">
                                <input type="text" placeholder="Name" value="{{ old('name', $user->name) }}"
