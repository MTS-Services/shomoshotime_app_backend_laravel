    ...
    <div class="glass-card rounded-xl">
        <div class="flex items-center justify-between p-4 lg:p-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <!-- Profile -->
                <div class="relative" x-data="{ open: false, isRtl: document.documentElement.dir === 'rtl' }">

                    <!-- Toggle Button -->
                    <button @click="open = !open" class="image">
                        <div class="w-10 h-10 rounded-full">
                            <img src="{{ auth_storage_url(user()->image) }}" alt=""
                    ...
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
                        ...
                        class="hidden absolute mt-2 w-fit min-w-40 glass-card bg-bg-white dark:bg-bg-dark-tertiary rounded-xl shadow-lg py-2 z-50"
                        :class="{
                            '!block': open,
                            '!right-0': !isRtl,
                            '!left-0': isRtl
                        ...
                        <div class="p-2">
                            <a href="{{ route('user-profile') }}"
                                ...
                                <i class="fas fa-user mr-3 w-4"></i>{{ __('Profile') }}
                            </a>
                            <a href="#"
                                class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                                <i class="fas fa-cog mr-3 w-4"></i>{{ __('Settings') }}
                            </a>
