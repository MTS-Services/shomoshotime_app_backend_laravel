...
use App\Http\Requests\Admin\UserManagement\AdminRequest;
use App\Http\Traits\AuditRelationTraits;
use App\Http\Traits\FileManagementTrait;
use App\Models\Admin;
use App\Services\UserManagement\AdminService;
...
class AdminController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $query = $this->adminService->getAdmins()->admin();
        ...
        return view('backend.admin.user-management.admin.index');
    }
    ...
    {
        return view('backend.admin.user-management.admin.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.user-management.admin.edit', $data);
    }
    ...
    {
        if ($request->ajax()) {
            $query = $this->adminService->getAdmins()->onlyTrashed()->admin();
            return DataTables::eloquent($query)
        ...
        return view('backend.admin.user-management.admin.trash');
    }
