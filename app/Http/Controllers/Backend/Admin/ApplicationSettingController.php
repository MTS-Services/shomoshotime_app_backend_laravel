...
use App\Http\Requests\Admin\ApplicationSettingRequest as AdminApplicationSettingRequest;
...
class ApplicationSettingController extends Controller implements HasMiddleware
{
    ...
    {
        $data['general_settings'] = ApplicationSetting::whereIn('key', ['app_name', 'short_name', 'timezone', 'date_format', 'time_format', 'theme_mode', 'app_logo', 'favicon', 'public_registration', 'registration_approval', 'environment', 'app_debug', 'debugbar'])->pluck('value', 'key')->all();
    ...
    public function updateSettings(AdminApplicationSettingRequest $request): RedirectResponse
    {
        try {
