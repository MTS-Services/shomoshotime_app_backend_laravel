...
class PropertyCreateRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['sometimes', 'nullable', 'string', 'unique:properties,slug'],
            'description' => ['required', 'string'],
            'price' => ['required', 'numeric'],
            'status' => ['required', 'integer', Rule::in([Property::STATUS_PENDING, Property::STATUS_OPEN, Property::STATUS_ARCHIVE])],
            'primary_file' => [
                'required',
                'file',
